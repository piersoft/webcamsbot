...
<div id="infodiv" style="leaflet-popup-content-wrapper">
  <p><b>WebCamsTravelBot https://telegram.me/webcamstravelbot by @piersoft<br></b>
		EasyMap webcams provided by <a href="http://www.webcams.travel">webcams.travel</a>
</div>
...
var  zoom = parseFloat('<?php printf($_GET['z']); ?>');
console.log(zoom);
if (!zoom) {
	zoom=14;
}
